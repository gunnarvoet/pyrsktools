...
def derivesalinity(self: RSK, seawaterLibrary: str = "TEOS-10") -> None:
    ...
    self.appendchannel(Salinity, salinity, False, True)
...
def deriveseapressure(self: RSK, patm: Optional[Union[float, Collection[float]]] = None) -> None:
    ...
    self.appendchannel(SeaPressure, seapressure, False, True)
...
def derivedepth(self: RSK, latitude: float = 45.0, seawaterLibrary: str = "TEOS-10") -> None:
    ...
    self.appendchannel(Depth, depth, False, True)
    self.appendlog(
...
def derivevelocity(self: RSK, windowLength: int = 3) -> None:
    ...
    self.appendchannel(Velocity, velocity, False, True)
    self.appendlog(
...
def deriveC25(self: RSK, alpha: float = 0.0191) -> None:
    ...
    self.appendchannel(SpecificConductivity, specificConductivity, False, True)
    self.appendlog(
...
def deriveBPR(self: RSK) -> None:
    ...
    for i in range(nParos):
        ...
        self.appendchannel(derivedPChannel, pres, False, True)
        self.appendchannel(derivedTChannel, temp, False, True)
...
def _deriveconcentration(self: RSK, unit: str) -> None:
    ...
    self.appendchannel(channel, concentration, False, True)
...
def _derivesaturation(self: RSK) -> None:
    ...
    self.appendchannel(DissolvedO2Saturation, saturation, False, True)
    self.appendlog(
...
def derivebuoyancy(self: RSK, latitude: float = 45.0, seawaterLibrary: str = "TEOS-10") -> None:
    ...
    self.appendchannel(BuoyancyFrequencySquared, buoyancy, False, True)
    self.appendchannel(Stability, stability, False, True)
    self.appendlog(
...
def derivesigma(
    ...
    self.appendchannel(DensityAnomaly, densityAnomaly, False, True)
...
def deriveSA(
    ...
    self.appendchannel(AbsoluteSalinity, absoluteSalinity, False, True)
...
def derivetheta(
    ...
    self.appendchannel(PotentialTemperature, potentialTemperature, False, True)
...
def derivesoundspeed(self: RSK, soundSpeedAlgorithm: str = "UNESCO") -> None:
    ...
    self.appendchannel(SpeedOfSound, speedOfSound, False, True)
...
def deriveA0A(self: RSK) -> None:
    ...
    for i, bprChannel in enumerate(bprChannels):
        ...
        if m := hasNumRe.search(bprChannel):
            ...
            self.appendchannel(BprCorrectedPressure, bprCorrection, False, True)
            self.appendchannel(PressureDrift, pressureCorrection, False, True)
...
def deriveAPT(
    ...
    self.appendchannel(AccelerationX, accX, False, True)
    self.appendchannel(AccelerationY, accY, False, True)
    self.appendchannel(AccelerationZ, accZ, False, True)
    self.appendchannel(AccelerometerTemperature, temp, False, True)
